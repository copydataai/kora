...
enum KoraPhase: Int, CaseIterable, Identifiable, Hashable {
    ...
    var title: String {
        switch self {
        case .planning:
            return "Phase 0 — Plan Stabilization"
        case .mvp:
            return "Phase 1 — v0.9 Multiplayer MVP"
        case .v10:
            return "Phase 2 — v1.0 Recommended Baseline"
        case .v13:
            return "Phase 3 — v1.3 Reliability"
        case .v15:
            return "Phase 4 — v1.5 Media Expansion"
        case .v2:
            return "Phase 5 — v2.0 Community Scale"
        }
    }
    ...
    var goal: String {
        switch self {
        case .planning:
            return "Align docs, repo structure, and delivery definition with explicit acceptance criteria."
        case .mvp:
            return "Ship a practical multiplayer audio loop with self-service quality checks."
        case .v10:
            return "Deliver signed install path, widget extension, and video extension model reuse."
        case .v13:
            return "Harden concurrency, quality rules, and resilience for larger teams/files."
        case .v15:
            return "Expand supported media format surface and richer production features."
        case .v2:
            return "Open plugin architecture for codecs and room actions with community contribution pathways."
        }
    }
